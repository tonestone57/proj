...
This document provides a comprehensive mapping of every file in the SGI-Alpha repository, <br>detailing its purpose and its specific role within the LLM-driven APW architecture.
...
| compilation_errors.log | System diagnostic log file capturing detailed telemetry and runtime events for <br>compilation errors monitoring and troubleshooting. | Utility/Config |
...
| hardware_verification.log | System diagnostic log file capturing detailed telemetry and runtime events for <br>hardware verification monitoring and troubleshooting. | Utility/Config |
...
| actors/reasoner_actor.py | High-fidelity logical inference engine that integrates Z3 SMT solvers for formal verification. It operates natively in sym_int8 precision to achieve maximum AVX2 throughput on Intel hardware while proving code correctness and logical consistency. | Ray Actor (Distributed) |
...
| actors/social/social_reasoner.py | Infers social context and user intentions by analyzing episodic memory history. It generates nuanced, socially-aware responses that maintain identity continuity and alignment with the user's inferred goals. | Ray Actor (Distributed) |
...
| blueteam/detection_engine.py | A core logic engine for specialized domain processing in the Blueteam module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| File | Description | Integration Role |
| :--- | :--- | :--- |
| cee_layer/cee_manager.py | Integrates Cognitive, Emotional, and Ethical layers to perform moral weighting of actions. It serves as the final bridge between affective dynamics and ethical evaluation for high-stakes decision making. | Ray Actor (Distributed) |
| cee_layer/cognitive_affective_bridge.py | Implements core cognitive affective bridge logic. Supports the primary <br>functional requirements of the Cee Layer subsystem within the SGI framework. | Logic Component |
| cee_layer/emotion_appraisal.py | Implements core emotion appraisal logic. Supports the primary <br>functional requirements of the Cee Layer subsystem within the SGI framework. | Logic Component |
| cee_layer/emotion_generator.py | Implements core emotion generator logic. Supports the primary <br>functional requirements of the Cee Layer subsystem within the SGI framework. | Logic Component |
| cee_layer/emotion_regulator.py | Implements core emotion regulator logic. Supports the primary <br>functional requirements of the Cee Layer subsystem within the SGI framework. | Logic Component |
| cee_layer/ethical_evaluator.py | Implements core ethical evaluator logic. Supports the primary <br>functional requirements of the Cee Layer subsystem within the SGI framework. | Logic Component |
| cee_layer/moral_weighting.py | Implements core moral weighting logic. Supports the primary <br>functional requirements of the Cee Layer subsystem within the SGI framework. | Logic Component |

## Conflict Resolution (`conflict_resolution/`)

| File | Description | Integration Role |
| :--- | :--- | :--- |
| conflict_resolution/conflict_manager.py | Resolves internal contradictions between diverse belief systems and moral perspectives. It uses probabilistic reasoning and value arbitration protocols to finalize decisions when multiple objectives are in conflict. | Ray Actor (Distributed) |
| conflict_resolution/contradiction_detector.py | Implements core contradiction detector logic. Supports the primary <br>functional requirements of the Conflict Resolution subsystem within the SGI framework. | Logic Component |
| conflict_resolution/ethical_appraisal.py | Implements core ethical appraisal logic. Supports the primary <br>functional requirements of the Conflict Resolution subsystem within the SGI framework. | Logic Component |
| conflict_resolution/moral_agents.py | Implements core moral agents logic. Supports the primary <br>functional requirements of the Conflict Resolution subsystem within the SGI framework. | Logic Component |
| conflict_resolution/probabilistic_reasoner.py | Implements core probabilistic reasoner logic. Supports the primary <br>functional requirements of the Conflict Resolution subsystem within the SGI framework. | Logic Component |
| conflict_resolution/resolution_protocol.py | Implements core resolution protocol logic. Supports the primary <br>functional requirements of the Conflict Resolution subsystem within the SGI framework. | Logic Component |
| conflict_resolution/survivability_engine.py | A core logic engine for specialized domain processing in the Conflict Resolution module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| conflict_resolution/value_arbitration.py | Implements core value arbitration logic. Supports the primary <br>functional requirements of the Conflict Resolution subsystem within the SGI framework. | Logic Component |
...
| console/escalation_engine.py | A core logic engine for specialized domain processing in the Console module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| File | Description | Integration Role |
| :--- | :--- | :--- |
| core/base.py | Provides the fundamental base class (CognitiveModule) for all integrated SGI agents. It handles automated registration with the Global Workspace, standardizes constructor signatures, and provides a unified asynchronous message routing interface. | Cognitive Module (Integrated) |
...
| core/message_bus/priority_engine.py | A core logic engine for specialized domain processing in the Message Bus module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| core/message_bus/router.py | Implements core router logic. Supports the primary <br>functional requirements of the Message Bus subsystem within the SGI framework. | Logic Component |
...
| economics/context_engine.py | A core logic engine for specialized domain processing in the Economics module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| economics/economic_manager.py | Manages resource allocation and utility optimization within the system. It coordinates agent policies and coordination protocols to ensure fair and efficient use of computational resources in a multi-agent environment. | Ray Actor (Distributed) |
| economics/fairness_engine.py | A core logic engine for specialized domain processing in the Economics module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| economics/utility_engine.py | A core logic engine for specialized domain processing in the Economics module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| emotion/emotion_manager.py | Models and manages the system's affective state through appraisal processes. It bridges cognitive and emotional dynamics to provide a more nuanced and human-aligned interaction model. | Ray Actor (Distributed) |

## Incident Response (`incident_response/`)

| File | Description | Integration Role |
| :--- | :--- | :--- |
| incident_response/audit_logger.py | Implements core audit logger logic. Supports the primary <br>functional requirements of the Incident Response subsystem within the SGI framework. | Logic Component |
| incident_response/containment_engine.py | A core logic engine for specialized domain processing in the Incident Response module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| incident_response/detectors.py | Implements core detectors logic. Supports the primary <br>functional requirements of the Incident Response subsystem within the SGI framework. | Logic Component |
| incident_response/eradication_engine.py | A core logic engine for specialized domain processing in the Incident Response module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| incident_response/incident_classifier.py | Implements core incident classifier logic. Supports the primary <br>functional requirements of the Incident Response subsystem within the SGI framework. | Logic Component |
| incident_response/incident_manager.py | Coordinates the detection, containment, and recovery processes for cognitive anomalies or system failures. It manages specialized response engines to ensure rapid restoration of nominal SGI operations after an incident. | Ray Actor (Distributed) |
| incident_response/recovery_engine.py | A core logic engine for specialized domain processing in the Incident Response module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| incident_response/semantic_checks.py | Implements core semantic checks logic. Supports the primary <br>functional requirements of the Incident Response subsystem within the SGI framework. | Logic Component |

## Institutional Ai (`institutional_ai/`)

| File | Description | Integration Role |
| :--- | :--- | :--- |
| institutional_ai/coordination_layer.py | Implements core coordination layer logic. Supports the primary <br>functional requirements of the Institutional Ai subsystem within the SGI framework. | Logic Component |
| institutional_ai/governance_graph.py | Implements core governance graph logic. Supports the primary <br>functional requirements of the Institutional Ai subsystem within the SGI framework. | Logic Component |
| institutional_ai/incentive_engine.py | A core logic engine for specialized domain processing in the Institutional Ai module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| institutional_ai/oversight_agents.py | Implements core oversight agents logic. Supports the primary <br>functional requirements of the Institutional Ai subsystem within the SGI framework. | Logic Component |
| institutional_ai/real_time_control.py | Implements core real time control logic. Supports the primary <br>functional requirements of the Institutional Ai subsystem within the SGI framework. | Logic Component |
| institutional_ai/role_definitions.py | Implements core role definitions logic. Supports the primary <br>functional requirements of the Institutional Ai subsystem within the SGI framework. | Logic Component |
| institutional_ai/rule_engine.py | A core logic engine for specialized domain processing in the Institutional Ai module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| institutional_ai/sanction_engine.py | A core logic engine for specialized domain processing in the Institutional Ai module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| institutional_ai/trust_engine.py | A core logic engine for specialized domain processing in the Institutional Ai module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| memory/short_term/episodic_memory.py | Implements core episodic memory logic. Supports the primary <br>functional requirements of the Short Term subsystem within the SGI framework. | Logic Component |
...
| memory_consolidation/consolidation_scheduler.py | Implements core consolidation scheduler logic. Supports the primary <br>functional requirements of the Memory Consolidation subsystem within the SGI framework. | Logic Component |
| memory_consolidation/generative_trainer.py | Implements core generative trainer logic. Supports the primary <br>functional requirements of the Memory Consolidation subsystem within the SGI framework. | Logic Component |
| memory_consolidation/hippocampal_replay.py | Implements core hippocampal replay logic. Supports the primary <br>functional requirements of the Memory Consolidation subsystem within the SGI framework. | Logic Component |
...
| File | Description | Integration Role |
| :--- | :--- | :--- |
| meta_learning/adaptation_engine.py | A core logic engine for specialized domain processing in the Meta Learning module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| meta_learning/meta_manager.py | Refines high-level strategies by analyzing performance metrics across various modules. It adapts module parameters and updates meta-policies to optimize the system's long-term learning and problem-solving capabilities. | Ray Actor (Distributed) |
| meta_learning/meta_policy.py | Implements core meta policy logic. Supports the primary <br>functional requirements of the Meta Learning subsystem within the SGI framework. | Logic Component |
| meta_learning/performance_tracker.py | Implements core performance tracker logic. Supports the primary <br>functional requirements of the Meta Learning subsystem within the SGI framework. | Logic Component |
| meta_learning/strategy_optimizer.py | Implements core strategy optimizer logic. Supports the primary <br>functional requirements of the Meta Learning subsystem within the SGI framework. | Logic Component |

## Metacognition (`metacognition/`)

| File | Description | Integration Role |
| :--- | :--- | :--- |
| metacognition/adaptation_engine.py | A core logic engine for specialized domain processing in the Metacognition module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| metacognition/metacognition_manager.py | Enables higher-order introspection by monitoring internal reasoning traces and decision-making patterns. It evaluates the transparency and quality of cognitive processes to support adaptive learning and self-correction. | Ray Actor (Distributed) |
...
| metacognition/transparency_engine.py | A core logic engine for specialized domain processing in the Metacognition module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |

## Monitoring (`monitoring/`)

| File | Description | Integration Role |
| :--- | :--- | :--- |
| monitoring/conformance_engine.py | A core logic engine for specialized domain processing in the Monitoring module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| motivation/motivation_manager.py | Drives the system's curiosity and uncertainty-reduction goals. It evaluates actions based on intrinsic rewards, novelty, and goal progress to maintain proactive engagement with the environment. | Ray Actor (Distributed) |
...
| motivation/reward_engine.py | A core logic engine for specialized domain processing in the Motivation module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| File | Description | Integration Role |
| :--- | :--- | :--- |
| negotiation/compliance_engine.py | A core logic engine for specialized domain processing in the Negotiation module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| negotiation/consensus_engine.py | A core logic engine for specialized domain processing in the Negotiation module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| negotiation/negotiation_manager.py | Orchestrates complex multi-agent negotiations using concession strategies and treaty formulations. It manages the lifecycle of negotiation sessions and ensures consensus-driven outcomes aligned with system utility. | Ray Actor (Distributed) |
...
| File | Description | Integration Role |
| :--- | :--- | :--- |
| purpleteam/bas_engine.py | A core logic engine for specialized domain processing in the Purpleteam module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| purpleteam/remediation_engine.py | A core logic engine for specialized domain processing in the Purpleteam module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| purpleteam/scoring_engine.py | A core logic engine for specialized domain processing in the Purpleteam module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
| purpleteam/selfplay_engine.py | A core logic engine for specialized domain processing in the Purpleteam module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| redteam/scenario_engine.py | A core logic engine for specialized domain processing in the Redteam module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| safety_ethics/conflict_resolver.py | Implements core conflict resolver logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/constraint_enforcer.py | Implements core constraint enforcer logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/deception_detector.py | Implements core deception detector logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/ethical_appraisal.py | Implements core ethical appraisal logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
...
| safety_ethics/governance_graph.py | Implements core governance graph logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/interpretability_monitor.py | Implements core interpretability monitor logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/moral_reasoner.py | Implements core moral reasoner logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/norm_library.py | Implements core norm library logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/oversight_agent.py | Implements core oversight agent logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/risk_classifier.py | Implements core risk classifier logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |
| safety_ethics/safety_manager.py | The primary enforcement layer for behavioral constraints and ethical alignment. It orchestrates multi-layered safety checks, risk classification, and proactive vetting of all cognitive actions before they are executed. | Ray Actor (Distributed) |
| safety_ethics/shutdown_controller.py | Implements core shutdown controller logic. Supports the primary <br>functional requirements of the Safety Ethics subsystem within the SGI framework. | Logic Component |

## Self Model (`self_model/`)

| File | Description | Integration Role |
| :--- | :--- | :--- |
| self_model/autobiographical_memory.py | Implements core autobiographical memory logic. Supports the primary <br>functional requirements of the Self Model subsystem within the SGI framework. | Logic Component |
| self_model/continuity_metrics.py | Implements core continuity metrics logic. Supports the primary <br>functional requirements of the Self Model subsystem within the SGI framework. | Logic Component |
| self_model/identity_kernel.py | Implements core identity kernel logic. Supports the primary <br>functional requirements of the Self Model subsystem within the SGI framework. | Logic Component |
| self_model/reflective_endorsement.py | Implements core reflective endorsement logic. Supports the primary <br>functional requirements of the Self Model subsystem within the SGI framework. | Logic Component |
| self_model/self_manager.py | Maintains the system's identity continuity and autobiographical memory. It tracks reflective endorsements and temporal self-metrics to ensure a stable and consistent internal model of the SGI agent. | Ray Actor (Distributed) |
| self_model/temporal_self.py | Implements core temporal self logic. Supports the primary <br>functional requirements of the Self Model subsystem within the SGI framework. | Logic Component |
...
| simulation/metrics_engine.py | A core logic engine for specialized domain processing in the Simulation module. <br>Implements underlying algorithms and state transformations required for functional objectives. | Logic Component |
...
| simulation/simulation_manager.py | Coordinates simulated environment interactions for testing and validation. It orchestrates the core simulation loop, applies governance interventions, and analyzes metrics to evaluate agent behavior in diverse scenarios. | Ray Actor (Distributed) |
...
| File | Description | Integration Role |
| :--- | :--- | :--- |
| world_model/causal_graph.py | Implements core causal graph logic. Supports the primary <br>functional requirements of the World Model subsystem within the SGI framework. | Logic Component |
| world_model/counterfactuals.py | Implements core counterfactuals logic. Supports the primary <br>functional requirements of the World Model subsystem within the SGI framework. | Logic Component |
| world_model/manager.py | Maintains the system's internal representation of reality and its Digital Twin. It simulates causal effects, tracks external environment state, and provides prediction services to support counterfactual reasoning and planning. | Ray Actor (Distributed) |
| world_model/prediction.py | Implements core prediction logic. Supports the primary <br>functional requirements of the World Model subsystem within the SGI framework. | Logic Component |
| world_model/simulator.py | Implements core simulator logic. Supports the primary <br>functional requirements of the World Model subsystem within the SGI framework. | Logic Component |
